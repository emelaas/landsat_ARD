...
#x11(h=8,w=8)
pdf(h=8,w=8,'/projectnb/modislc/projects/landsat_sentinel/ARD/figures/NCC/ard_tile_goodslope.pdf')
...
#x11(h=5,w=8)
pdf(h=5,w=8,'/projectnb/modislc/projects/landsat_sentinel/ARD/figures/NCC/goodslope_by_Tavg.pdf')
barCenters <- barplot(t(perc.group),beside=TRUE,names=c(0,1,2,3,4,5,6,7),ylim=c(0,1.5),
  main='% Grid Cells w/ Slope Not Significantly Different than 1',
