...
RMSE1 <- raster('RMSE1.tif')
pval1 <- raster('pval1.tif')
cor1 <- raster('cor1.tif')
slope1 <- raster('slope_sig1.tif')

RMSE2 <- raster('RMSE2.tif')
pval2 <- raster('pval2.tif')
cor2 <- raster('cor2.tif')
slope2 <- raster('slope_sig2.tif')

RMSE3 <- raster('RMSE3.tif')
pval3 <- raster('pval3.tif')
cor3 <- raster('cor3.tif')
slope3 <- raster('slope_sig3.tif')
...
goodpix1[RMSE1<5 & pval1<0.05 & cor1>0.5 & slope1==1] <- 1

goodpix2 <- RMSE2
goodpix2[goodpix2>-9999] <- NA
goodpix2[RMSE2<5 & pval2<0.05 & cor2>0.5 & slope2==1] <- 1

goodpix3 <- RMSE3
goodpix3[goodpix3>-9999] <- NA
goodpix3[RMSE3<5 & pval3<0.05 & cor3>0.5 & slope3==1] <- 1
...
#x11(h=8,w=8)
pdf(h=8,w=8,'/projectnb/modislc/projects/landsat_sentinel/ARD/figures/NCC/ard_tile_goodpix.pdf')
...
#x11(h=5,w=8)
pdf(h=5,w=8,'/projectnb/modislc/projects/landsat_sentinel/ARD/figures/NCC/goodpix_by_Tavg.pdf')
barCenters <- barplot(t(perc.group),beside=TRUE,names=c(0,1,2,3,4,5,6,7),ylim=c(0,0.6),
